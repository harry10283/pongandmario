...
function Map:create()
    ...
    local this = {
        ...
        mapWidth = 100,
        mapHeight = 28,
        VIRTUAL_HEIGHT = 600, -- Replace 600 with your actual height
        TILE_SIZE = 16, -- Replace 16 with your actual size
        VIRTUAL_WIDTH = 800,
        tiles = {},
    ...
    VIRTUAL_HEIGHT = 243 -- Replace 600 with your actual height
    TILE_SIZE = 16 -- Replace 16 with your actual size
    VIRTUAL_WIDTH = 432
    for y = VIRTUAL_HEIGHT / TILE_SIZE - 4, VIRTUAL_HEIGHT / TILE_SIZE - 1 do
        local pyramidWidth = VIRTUAL_WIDTH / TILE_SIZE - y
        for x = 1, pyramidWidth do
            table.insert(tiles, Tile:new(x, y, TILE_BRICK))
        end
    end
    local flagX = VIRTUAL_WIDTH / TILE_SIZE
    local flagY = VIRTUAL_HEIGHT / TILE_SIZE - 4
    table.insert(tiles, Tile:new(flagX, flagY, TILE_FLAG))
